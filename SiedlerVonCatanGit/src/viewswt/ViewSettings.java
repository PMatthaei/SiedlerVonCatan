...
public class ViewSettings {
	...
	public static int playerWidth() {
		ImageIcon player1Icon = new ImageIcon(ViewSettings.class.getResource("/textures/player/mini/player_yellow.png"));
	...
	/** ImageIcons */
	public static ImageIcon infoIcon = new ImageIcon(ViewSettings.class.getResource("/textures/symbols/info.png"));
