...
public class ExampleServerList extends JFrame {
   ...
   * Constructor
   * 
   * @param cname Identification for clients
   * @param version Client version
   * @param sname Identification for servers
   */
   ...
   * 
   * This thread waits for the discovery service to change, then tells the Swing
   * thread to update the Swing UI.
   *
   * @author Erich Schubert
   */
